      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center border-t border-[#2a3441] pt-8">
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mb-4 text-sm">
            ...
            <div className="flex items-center gap-4">
              <p>Find Us Here: <a href="https://www.google.com/maps/search/?api=1&query=2501+W+5th+St+Santa+Ana+CA+92703" target="_blank" rel="noopener noreferrer">2501 W 5th St, Santa Ana, CA 92703​</a></p>
            </div>
          </div>
